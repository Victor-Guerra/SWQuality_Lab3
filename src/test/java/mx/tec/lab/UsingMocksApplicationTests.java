...
class UsingMocksApplicationTests {
	...
	@Mock List<String> swordsList;
	@Captor ArgumentCaptor<String> swordName;
	@Mock Map<String, String> translationMap;
	@InjectMocks DothrakiTranslator translator = new DothrakiTranslator();
	...
	@Test 
	public void whenUsingMockAnnotation_thenMockIsInjected() {
